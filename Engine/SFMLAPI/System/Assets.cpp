...
{
std::array<std::string_view, ToIdx(AssetType::_COUNT)> g_szAssetType = {"TextureAsset", "FontAsset", "SoundAsset", "TextAsset",
																		"FileAsset"};
...
SoundAsset::SoundAsset(std::string id, Fixed volumeScale)
