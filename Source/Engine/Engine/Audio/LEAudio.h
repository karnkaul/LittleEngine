...
public:
	...
	SoundPlayer* PlaySFX(String id, Fixed volume = Fixed::One, Fixed direction = Fixed::Zero, bool bLoop = false);
	SoundPlayer* PlaySFX(class SoundAsset& sound, Fixed volume = Fixed::One, Fixed direction = Fixed::Zero, bool bLoop = false);
