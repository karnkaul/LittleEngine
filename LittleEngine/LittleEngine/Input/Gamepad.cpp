...
//}
//
//Gamepad::InputMapping::InputMapping(GameInputType gameInput, u16 joyButton) : gameInput(gameInput)
//{
//	joyButtons.push_back(joyButton);
//}
//
...
//}
//
//bool Gamepad::InputMapping::IsMapped(u16 joyButton) const
//{
//	return Core::Search(joyButtons, joyButton) != joyButtons.end();
//}
//
...
//}
//
//GameInputType Gamepad::ToGameInputType(u8 joyButton) const
//{
//	for (auto& binding : m_bindings)
//	{
//		if (binding.IsMapped(joyButton))
//		{
//			return binding.gameInput;
//		}
//	}
...
//}
//
//void Gamepad::Bind(GameInputType gameInput, u16 joyButton)
//{
//	for (auto& binding : m_bindings)
//	{
//		if (binding.gameInput == gameInput)
...
//			if (!binding.IsMapped(joyButton))
//			{
//				binding.joyButtons.emplace_back(joyButton);
//			}
//			return;
//		}
//	}
//	m_bindings.emplace_back(gameInput, joyButton);
//}
//
//void Gamepad::Bind(GameInputType gameInput, InitList<u16> joyButtons)
//{
//	for (auto id : joyButtons)
//	{
//		Bind(gameInput, id);
//	}
//}
