...
extern class ShaderRepository* g_pShaders;

class ShaderRepository final
{
private:
	static ShaderRepoData s_data;
	static UMap<String, UPtr<SFShader>> s_shaderMap;

public:
	ShaderRepository(ShaderRepoData data = {});
	~ShaderRepository();
