...
#define TweakS32(id, address) \
	LittleEngine::Debug::Tweakable id(#id, LittleEngine::Debug::TweakType::S32, "-1", address)
#define TweakF32(id, address) \
	LittleEngine::Debug::Tweakable id(#id, LittleEngine::Debug::TweakType::F32, "-1.0", address)
#define TweakString(id, address) \
	LittleEngine::Debug::Tweakable id(#id, LittleEngine::Debug::TweakType::STRING, "", address)
#else
