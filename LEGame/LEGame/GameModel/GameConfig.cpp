...
u32 GameConfig::GetTicksPerSecond() const
{
	return static_cast<u32>(m_uData->GetS32(TICKS_PER_SECOND_KEY));
}

u32 GameConfig::GetMaxTickTimeMS() const
{
...
void GameConfig::Verify()
{
	...
	m_bDirty |= SetStringIfEmpty(*m_uData, TICKS_PER_SECOND_KEY, Strings::ToString(60));
	m_bDirty |= SetStringIfEmpty(*m_uData, MAX_TICK_TIME_MS, Strings::ToString(50));
