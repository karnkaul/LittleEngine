...
#include "LEGame/GameModel/UI/UIObject.h"
...
private:
	void OnCreate(GameManager& gameManager, String name, LayerID rootLayer);
...
T* UIContext::AddElement(String name, UITransform* pParent, s32 layerDelta)
{
	...
	uT->OnCreate(*m_pGameManager->Context(), std::move(name), pParent);
